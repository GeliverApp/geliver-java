...
public class OneStep {
  public static void main(String[] args) {
    ...
    var sender = client.addresses().createSender(new HashMap<>() {{
      put("name","OneStep Sender"); put("email","sender@example.com"); put("phone","+905000000099");
    ...
    var tx = client.transactions().create(new HashMap<>() {{
      ...
      put("recipientAddress", new HashMap<>() {{
        put("name","OneStep Recipient"); put("phone","+905000000000"); put("address1","Dest 2"); put("countryCode","TR"); put("cityName","Istanbul"); put("cityCode","34"); put("districtName","Esenyurt");
      }});
